...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.bontoncoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("bontoncointools.com", "dnsseed.bontoncointools.com"));
        vSeeds.push_back(CDNSSeedData("bontoncoinpool.org", "dnsseed.bontoncoinpool.org"));
        ...
        fDefauBONonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("bontoncointools.com", "testnet-seed.bontoncointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bontoncoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        fDefauBONonsistencyChecks = true;
        fRequireStandard = false;
