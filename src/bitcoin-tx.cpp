...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bontoncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bontoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bontoncoin transaction") + "\n" +
              "  bontoncoin-tx [options] -create [commands]   " + _("Create hex-encoded bontoncoin transaction") + "\n" +
              "\n";
